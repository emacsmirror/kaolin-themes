  ...
  (when kaolin-themes-treemacs-icons
    ...
    (treemacs-create-theme "Kaolin"
                           ...
                           (progn
                             ...
                             (treemacs-create-icon :icon (format " %s " (all-the-icons-alltheicon "clojure-line" :v-adjust 0.02)) :extensions ("clj" "cljc" "cljc" "cljx" "deps.edn") :fallback 'same-as-icon)
                             (treemacs-create-icon :icon (format " %s " (all-the-icons-fileicon "cljs")) :extensions ("cljs" "shadow-cljs.edn") :fallback 'same-as-icon)
